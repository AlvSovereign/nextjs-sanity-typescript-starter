...
var validation = (0, _createMemoizer.memoize)((idPair, typeName) => {
  return (0, _rxjs.concat)((0, _rxjs.of)(INITIAL_VALIDATION_STATUS), (0, _editState2.editState)(idPair, typeName).pipe((0, _operators.switchMap)(_editState => (0, _rxjs.concat)((0, _rxjs.of)({
    ...
    isValidating: false
  }))), (0, _operators.scan)((prev, next) => _objectSpread(_objectSpread({}, prev), next), INITIAL_VALIDATION_STATUS), (0, _operators.scan)((prev, next) => {
    if ((0, _isEqual2.default)(prev.markers, next.markers)) {
      // Ensure referential identity if the markers did not change
      next.markers = prev.markers;
    }

    return next;
  }), (0, _operators.distinctUntilChanged)((prev, next) => prev.isValidating === next.isValidating && prev.markers === next.markers))).pipe((0, _operators.publishReplay)(1), (0, _operators.refCount)());
